...
function useWindowSize() {
  ...
  const createRuler = useCallback(() => {
    ...
    // Set cache of device orientation
  ...
  const [windowSize, setWindowSize] = useState(() => obtainSize());

  useEffect(() => {

    const handleResize = () => setWindowSize(obtainSize());
